...
document.write("<hr>")
document.write("<h1><u>CONDITION THERENARY</u></h1><br>")
var f = (100)
var g;
(f==100)? g = true: g = false;
document.write(g)
document.write("<hr>")
document.write("<h3><u>INCREMENT LOOP </u></h3><br>")
var h = (1)
while(h <= 10){
    document.write(h + "  this is while loop<br>");
    h++;
}
document.write("<h3><u>DECREMENT LOOP </u></h3><br>")
var i = (10)
while(i >= 1){
